...
fbc = FBCMeasures(streamlines,k,num_threads=6,verbose=True)
...
tracto = nib.streamlines.tractogram.Tractogram(mal_streamlines,affine_to_rasmm=sl_file.header['voxel_to_rasmm'])
