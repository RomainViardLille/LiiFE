...
Usage:
  FMRI_CompleteJsonFile.py <filepath> <filepath> <filepath> <value> <value> <value> <value> <filepath> 
...
stc=[]
#ATTENTION ICI le nombre de slice est en dur 40 ...alors que 48 pour Thalamotomy par exemple
